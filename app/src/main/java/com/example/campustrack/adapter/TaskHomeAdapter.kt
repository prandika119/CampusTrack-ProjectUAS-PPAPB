...
class TaskHomeAdapter (private var listTask: List<Task>, private val db: TaskRoomDatabase): RecyclerView.Adapter<TaskHomeAdapter.TaskViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TaskHomeAdapter.TaskViewHolder {
